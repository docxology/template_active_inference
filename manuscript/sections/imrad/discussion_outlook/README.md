...
IMRaD **Discussion** section of the Active Inference multi-track manuscript
(`projects/templates/template_active_inference`). This directory holds the Markdown
fragment(s) for the `discussion_outlook` section, which the renderer assembles into the
combined manuscript across the analytical, pymdp, and sheaf tracks.

- **Role in IMRaD:** Discussion.
