---
name: template-active-inference
description: Active Inference multi-track exemplar — analytical formulas, pymdp simulation, sheaf manuscript composition, GNN, ontology, Lean gates, roadmap tracks.
version: 0.1.0
author: docxology
license: MIT
tags: [exemplar, active-inference, multi-track, sheaf]
---

# template-active-inference

Project-scoped skill for the in-repo exemplar at
`projects/templates/template_active_inference/`. Load this when working inside the project.

## When to Use

- Working inside the `template_active_inference` exemplar — running scripts, editing source,
